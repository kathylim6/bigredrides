...
# class Trip_Deposit(db.Model):
#     """
#     Model for storing the deposits for a trip (both drivers and passengers put in 3%)
#     Has a one-to-one relationship with the Trips model
#     """
#     __tablename__ = "deposits"
#     id = db.Column(db.Integer, primary_key=True, autoincrement=True)
#     passenger_deposit = db.Column(db.Float, nullable = False) #if multiple passengers, add all deposits together (?)
#     driver_deposit = db.Column(db.Float, nullable = False)
#     trip_id = db.Column(db.Integer, db.ForeignKey("trips.id"), nullable = False)

#     def __init__(self, **kwargs):
#         """Initializes a Trip_Deposit object"""
#         self.trip_id = kwargs.get("trip_id", 0)
#         self.passenger_deposit = kwargs.get("passenger_deposit", 0.0)
#         self.driver_deposit = kwargs.get("driver_deposit", 0.0)
        
#     def serialize(self):
#         """Serializes a Trip_Deposit object"""
#         return {
#             "id": self.id,
#             "passenger_deposit": self.passenger_deposit,
#             "driver_deposit": self.driver_deposit,
